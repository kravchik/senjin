...
class ProgramGenerator {
    ...
    ProgramGenerator(String src, String srcPath, ShaderParent shaderGroovy, String programType) {
        this.shaderGroovy = shaderGroovy
        this.srcPath = srcPath
        this.resultSrc = translate(programType, src)
    }
    ...
    private String translate(String programType, String src) {
