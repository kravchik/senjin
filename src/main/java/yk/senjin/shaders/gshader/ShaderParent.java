...
//gglsl auto generated text
    ...
    public static float distance(Vec2f v1, Vec2f v2) {return v1.distance(v2);}
    public static float distance(Vec3f v1, Vec3f v2) {return v1.distance(v2);}
    public static float distance(Vec4f v1, Vec4f v2) {return v1.distance(v2);}
